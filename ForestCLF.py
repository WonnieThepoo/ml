...
data = pd.read_csv('/Users/winniethepooh/PycharmProjects/ml/data-out/abalone.csv')
...
with open('/Users/winniethepooh/PycharmProjects/ml/data-out/RandomForestCLF.txt', 'w') as f:
    f.write(str(anw))
    f.close()
