...
data = pd.read_csv('/Users/winniethepooh/PycharmProjects/ml/data-out/djia_index.csv')
data_close = pd.read_csv('/Users/winniethepooh/PycharmProjects/ml/data-out/close_prices.csv')
...
with open('/Users/winniethepooh/PycharmProjects/ml/data-out/index.txt', 'w') as f:
    f.write(str(cnt))
    f.close()
